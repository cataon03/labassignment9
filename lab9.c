...
void insertRecord(struct HashType *hashTable, struct RecordType *record, int tableSize)
{
	...
	int ind = hash(record->id, tableSize);
...
int main(void)
{
    ...
    struct HashType* hashTable = (struct HashType*)calloc(sizeof(struct HashType), hashTableSize);
